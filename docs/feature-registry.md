...
| F-REL-001 | Tag + GitHub Release v1.9.3 (signed, immutable) | policy pin | — | SRC c2a2c1c | — | — | — | — | **BLOCKED-PHYSICAL** | tag HARUS menunjuk commit evidence (hardware acceptance + OTA fisik) DI ATAS SRC — bukan main HEAD. Jangan tag sebelum evidence |
